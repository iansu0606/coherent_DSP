...
# Refers to : https://scipy-cookbook.readthedocs.io/items/EyeDiagram.html
# Github Link: https://github.com/WarrenWeckesser/eyediagram
cimport cython
...
cdef int bres_segment_count(int x0, int y0, int x1, int y1,
    ...
    """
    This is the implementation of Bresenham's algorithm.
    
    See http://en.wikipedia.org/wiki/Bresenham%27s_line_algorithm
    Simply intro:
    This algorithm helps to decide corresponding y that is closest to the ideal y,
